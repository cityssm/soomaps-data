...
export const layers: Layer[] = [
  ...
  },
  {
    ...
    layerURL:
      "https://services1.arcgis.com/nlLTq2Zj0Jwv1qft/ArcGIS/rest/services/SSM_Playgrounds/FeatureServer/0",
    fields: [
      "Playground_Name",
      "Playground_Location",
      "Address",
      ...
      "Age_4to5",
      "Age_6to12",
      "Playground_Surface_Type",
      "Playground_Surface_Other",
      "Swingset",
      "SaucerSwing",
      "Slides",
      "Bars",
      ...
      "SplashPad",
      "OtherEquipment_Desc",
      "OtherEquipment2_Desc",
      "OtherEquipment3_Desc",
      "BasketballCourt",
      "BaseballField",
      "SoccerField",
      "TennisCourt",
